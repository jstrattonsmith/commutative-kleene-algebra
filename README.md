...
The development is split into seven files with a linear dependency chain:
...
- **`repr_rel.v`** — Representable relations: `repr_rel`, `repr_rel_iter` (Lemma 21), `repr_rel_iter_empty` (Theorem 22).
- **`bounded_output.v`** — Bounded-output terms: `bounded_output`, closure lemmas (Lemma 30), `left_nonempty`, `bounded_outputb`, `prefix_free`.
